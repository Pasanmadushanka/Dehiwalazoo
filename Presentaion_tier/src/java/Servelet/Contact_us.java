 ...
 * @author Night
 */
@WebServlet(name = "Contact_us", urlPatterns = {"/Contact_us"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("btnsend") != null){
                if(proxy.sendingMessage(name, email, subject, message)){
                    request.setAttribute("message", "send");
                }
                else{
                     request.setAttribute("message", "notsent");
                }
            }
